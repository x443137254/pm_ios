...
-(instancetype)initWithStyle:(UITableViewCellStyle)style reuseIdentifier:(NSString *)reuseIdentifier{
    if (self = [super initWithStyle:style reuseIdentifier:reuseIdentifier]) {
        ...
        _titlesLab = [[UILabel alloc] initWithFrame:CGRectMake(10, 0, 0, 22)];
        [self addSubview:_titlesLab];
        _descsLab = [[UILabel alloc] initWithFrame:CGRectMake(10, 0, 0, 22)];
...
-(void)setWidth1:(CGFloat)width1{
    ...
    [_titlesLab setFrame:CGRectMake(10, 0, width1, 22)];
}

-(void)setWidth2:(CGFloat)width2{
    width2 = width2;
    if (width2 < 50 && width2 != 0) {
        width2 = 50;
    }
    [_descsLab setFrame:CGRectMake(CGRectGetMaxX(_titlesLab.frame) + 10, 0, width2, 22)];
}
